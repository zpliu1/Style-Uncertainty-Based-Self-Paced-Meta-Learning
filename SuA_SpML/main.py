...
start_epoch = best_mAP = best_rank1 = 0
...
def get_test_loader(dataset, height, width, batch_size, workers, testset=None):
    ...
    test_loader = DataLoader(
        Preprocessor_test(testset, root=dataset.images_dir, transform=test_transformer),
...
def main_worker(args):
    global start_epoch, best_mAP, best_rank1
    ...
    '''
    #data_dir1 = '/home/zhang/E/lzp/shuju'

    # market '/home/zhang/E/lzp/shuju'
    # msmt   '/home/zhang/E/lzp'
    # cuhk   '/home/zhang/E/lzp/cuhk_shuju/CUHK03_np/cuhk03-np'
    # duke   '/home/zhang/E/lzp/duke_shuju'


    file_dataset_src1 = '/home/zhang/E/lzp/duke_shuju'      #duke
    file_dataset_src2 = '/home/zhang/E/lzp'            #msmt
    file_dataset_src3 = '/home/zhang/E/lzp/cuhk_shuju/CUHK03_np/cuhk03-np'   #cuhk
    '''
    file_dataset_src1 = '/media/dl/8t1/lzp/data/market1501'  # market
    file_dataset_src2 = '/media/dl/8t1/lzp/data/MSMT'  # msmt
    file_dataset_src3 = '/media/dl/8t1/lzp/data/cuhk03/cuhk03-np'  # cuhk
    '''


    dataset_src1 = get_data(args.dataset_src1, file_dataset_src1)
    dataset_src2 = get_data(args.dataset_src2, file_dataset_src2)
    dataset_src3 = get_data(args.dataset_src3, file_dataset_src3)
    dataset = get_data(args.dataset, args.data_dir)
    ...
    source_centers_all = []
    #source_centers_all_1 = []
    #source_centers_all_2 = []
    memories = []
    memories_new = []
    memories_new2 = []
    ...
    for dataset_i in range(len(datasets_src)):
        ...
        memories_new.append(curMemo)
        memories_new2.append(curMemo)

        del source_centers, sour_cluster_loader, sour_fea_dict

    #memories_new = copy.deepcopy(memories)

    # Optimizer
    params = [{"params": [value]} for value in model.module.params() if value.requires_grad]

    optimizer = torch.optim.Adam(params, lr=args.lr, weight_decay=args.weight_decay)
    lr_scheduler = WarmupMultiStepLR(optimizer, milestones=[20, 30, 40], gamma=0.1, warmup_factor=0.01,
                                     warmup_iters=10, warmup_method="linear")

    criterion = TripletLoss(args.margin, args.num_instances, False).cuda()
    trainer = Trainer(args, model, memories, memories_new, memories_new2, criterion)
    ...
    for epoch in range(args.epochs):
        ...
        if (epoch + 1) % args.eval_step == 0 or (epoch == args.epochs - 1):
            ...
            cmc, mAP = evaluator.evaluate(test_loader, dataset.query, dataset.gallery, cmc_flag=True)
            cmc_0 = cmc[0]
            ...
            is_best_rank1 = (cmc_0 > best_rank1)
            best_rank1 = max(cmc_0, best_rank1)
            if is_best_rank1:
                state = {
                'state_dict': model.state_dict(),
                'epoch': epoch + 1,
                ...
                fpath =osp.join(args.logs_dir, 'best_rank1_check.pth.tar')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--width', type=int, default=128, help="input width")  #(384, 128)
